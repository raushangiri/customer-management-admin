...
const Adminbankloginhistory = () => {
    ...
    const fetchLoanFiles = async (start, end, agent = '', tl = '') => {
      ...
      setError(null);
      try {
        const response = await axios.get(`${baseurl}/getbankloginFilesByDate`, {
          params: {
            startDate: start,
            endDate: end,
    ...
    return (
      <div className="container  mt-4">
        <h2 className="mb-4">Bank Login Files History</h2>
                ...
                <tr key={loanFile._id}>
                  ...
                  <td>
                    {loanFile.banklogin_assign_date && (
                      <>
                        {new Date(loanFile.banklogin_assign_date).toLocaleDateString('en-GB')}<br />
                        {new Date(loanFile.banklogin_assign_date).toLocaleTimeString('en-US', {
                          hour: '2-digit',
                          minute: '2-digit',
                        })}
                      </>
                  ...
                  {userRole === 'admin' && (
                    <>
                      ...
                      <td>{loanFile.banklogin_agent_name}</td>
                    </>
                  )}
...
export default Adminbankloginhistory