...
const Tvrteamperformance = () => {
    ...
    const fetchFilteredData = async () => {
      ...
      try {
        setLoading(true);
        const response = await axios.get(`${baseurl}/gettvrperformanceByFilters`, {
          params: {
            startDate,
            endDate,
            teamLeaderName: selectedTeamLeader,
            tvrAgentName: selectedAgent,
          },
        });
...
export default Tvrteamperformance