...
const Bank_Login = ({onViewClick}) => {
  ...
  useEffect(() => {
    const fetchLoanFiles = async () => {
      try {
        const response = await axios.get(`${baseurl}/getProcessToBankloginFiles`); // Replace with your actual API endpoint
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4">Bank Login Files</h2>
