...
const Tvr_files = ({ onViewClick }) => {
  ...
  useEffect(() => {
    const fetchLoanFiles = async () => {
      try {
        const response = await axios.get(`${baseurl}/getProcessToTVRFiles`); // Replace with your actual API endpoint
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4">TVR Files</h2>
